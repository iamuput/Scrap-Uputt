...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "scrapuputtbot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "scrapuputtbot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/scrapuputtbot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/scrapuputtbot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Managed With 🐣 By @iamuput")
